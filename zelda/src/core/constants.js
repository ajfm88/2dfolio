...
export const GAME_OVER_OPTION_YS = [79, 103, 127]; // $4F, $67, $7F
...
export const LADDER_ROOMS_OW = [0x17, 0x18, 0x19, 0x27, 0x4F, 0x5F];
...
// NES screen Y values converted to play-area coords (subtract $3D).
export const RAFT_ARRIVAL_Y = 0x3D - 0x3D;             // 0 — Link arriving from scroll (top edge)
export const RAFT_DEPARTURE_Y = 0x7D - 0x3D;           // 64 — Link at dock
export const RAFT_MIDPOINT_Y = 0x7F - 0x3D;            // 66 — state 1 stop point
...
export const WHIRLWIND_DEST_ROOMS = [0x36, 0x3B, 0x73, 0x44, 0x0A, 0x21, 0x41, 0x6C];
...
export const WHIRLWIND_DEST_YS = [0x8D, 0xAD, 0x8D, 0x8D, 0xAD, 0x8D, 0xAD, 0x5D];

/** NES screen Y → play-area Y. */
export function nesScreenYToPlayArea(nesY) {
...
export const SWORD_DAMAGE = [0x00, 0x10, 0x20, 0x40]; // none, wood, white, magic
