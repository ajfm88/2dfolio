...
export const EndingPhase = Object.freeze({
  Flash: 0,
  PeaceText: 1,
  Credits: 2,
  AshTriforce: 3,
...
const FLASH_COLORS = ['#000000', '#0000a8', '#d82800', '#008800'];
...
export class EndingScreen {
  ...
  constructor(playerName, deathCount) {
    this.playerName = playerName.toUpperCase().padEnd(8, ' ');
    this.deathCount = deathCount;
  }

  get phase() { return this._phase; }
  get isDone() { return this._phase === EndingPhase.Done; }
  ...
  render(renderer, font) {
   ...
   renderAshTriforce(renderer, font) {
    renderer.fillRect(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, '#000');
