...
export const TitlePhase = Object.freeze({
  Title: 0,
  StoryScroll: 1
});
...
const WAVE_START_YS = [0xb6, 0xc8, 0xd8];
...
function anyJustPressed(input) {
  return ALL_ACTIONS.some(a => input.isJustPressed(a));
}

export class TitleScreen {
   _phase = TitlePhase.Title;
   idleTimer = 0;
   scrollY = 0;
   _goToFileSelect = false;
   _frameCounter = 0;
    _waveYs = [...WAVE_START_YS];
