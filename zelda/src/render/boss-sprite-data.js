...
export function initBossSprites(image) {
...
export function initNpcSprites(image) {
...
export function initLinkEndingSprite(image) {
...
export function drawLinkEndingSprite(renderer, dx, dy) {
...
export function drawLinkEndingSpriteUp(renderer, dx, dy) {
  if (!linkEndingSource) return;
