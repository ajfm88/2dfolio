...
export function getItemSpritePos(itemId) {
  return ITEM_SPRITE_MAP[itemId] ?? null;
}

// Process items.png to replace background color with transparency
let processedItemsCanvas = null;

export function processItemsImage(image) {
...
export const TRIFORCE_PIECE_SRC = { sx: 336, sy: 135, sw: 10, sh: 10 };
...
export function getProcessedItemsCanvas() {
...
let processedNESStrip = null;

export function processNESItemStrip(image) {
...
export function getProcessedNESStrip() {
