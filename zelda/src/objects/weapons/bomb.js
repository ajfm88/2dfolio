...
const BOMB_TIMES = [0x30, 0x18, 0x0C, 0x06];
...
export class Bomb {
  ...
  get isActive() { return this._state !== BombState.Dead; }
  get isDetonating() { return this._state === BombState.Detonating; }
  ...
  render(ctx, cloudSheet, renderer) {
    if (this._state === BombState.Dead) return;
   ...
   renderExplosion(ctx, cloudSheet, renderer) {
