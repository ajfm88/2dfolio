...
export const MagicShotState = Object.freeze({
  Flying: 0x80,
  Dead: 0x00
});
...
export class MagicShot {
  ...
  get isActive() { return this._state !== MagicShotState.Dead; }
  get wasBlocked() { return this._wasBlocked; }
