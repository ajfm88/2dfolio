...
export class Stepladder {
   ...
   _y;
    _direction;
   _state = LadderState.Approaching;

  constructor(linkX, linkY, direction) {
  ...
  get isActive() { return this._state !== LadderState.Done; }

  get tileRow() { return Math.floor(this._y / TILE_SIZE); }
  get tileCol() { return Math.floor(this._x / TILE_SIZE); }
