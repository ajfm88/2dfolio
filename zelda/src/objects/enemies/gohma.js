...
export class Gohma extends Enemy {
   ...
   _goStraight = false;
   _dirMask = DIR_RIGHT;
   _eyeState = EYE_CLOSED_LEFT;
   _eyeOpenTimer = 0;
   _nextOpenEyeCounter = 0;
   _eyeAnimCounter = 0;
   _shootTimer = 1; // starts at 1 so it doesn't fire immediately
   _frame = 0;

  constructor(_x, _y, objectType, hp, spawnCloudFrames) {
  ...
  get eyeState() { return this._eyeState; }
