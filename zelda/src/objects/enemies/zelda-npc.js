...
const ZeldaState = Object.freeze({
  Waiting: 0,
  RescueTriggered: 1
});

export class ZeldaNpc extends Enemy {
   _zeldaState = ZeldaState.Waiting;
   _rescueTimer = 0;
  ...
  get isEndingTriggered() { return this._endingTriggered; }

  get isRescueTriggered() {
