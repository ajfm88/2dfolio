...
import { drawBossSprite, DODONGO_SPRITES } from '../../render/boss-sprite-data.js';
...
const DState = Object.freeze({ Move: 0, Bloated: 1, Stunned: 2 });
...
export class Dodongo extends Enemy {
  ...
  get bombsEaten() { return this._bombHits; }
  ...
  // Dodongo_CheckBombHit: only while moving.
   reactToBombs(bombs) {
    ...
    for (const bomb of bombs) {
      ...
      if (unexploded) {
        const bombRect = { x: bomb.x, y: bomb.y, width: 16, height: 16 };
