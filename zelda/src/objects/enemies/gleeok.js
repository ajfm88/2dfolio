...
function headCountFromType(objectType) {
...
export class GleeokBody extends Enemy {
  ...
  constructor(x, y, objectType, hp, spawnCloudFrames) {
...
export class GleeokNeckHead extends Enemy {
  ...
  constructor(x, y, objectType, _hp, spawnCloudFrames, headIndex) {
  ...
  get headIndex() { return this._headIndex; }

  setBody(body) {
    this._body = body;
  }

   takeDamage(damage, fromDirection, hitContext) {
...
export class GleeokFlyingHead extends FlyerEnemy {
  ...
  constructor(x, y, objectType, hp, spawnCloudFrames) {
   ...
   takeDamage(_damage, _fromDirection, _hitContext) {
    return false;
  }
...
export function createGleeok(
  cx, cy, objectType, hp, spawnDelay,
) {
